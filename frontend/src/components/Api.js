...
export function Api({ }) {
  ...
  return (
    ...
    <CRow>
      ...
      <h4>By direct Link or Javascript integration:</h4>
        ...
        <CCard>
          <CCardBody>
            ...
            <CCardText>
              ...
              <CopyBlock
                language="html"
                text={`<script src="https://www.payperblock.xyz/payperblock.js" />
...
.then((txHash) => {
  ...
  // do something after the subscription
        ...
        <CCard>
          <CCardBody>
            ...
            <CCardText>
              ...
              Just use this URL: <a href="/#/mini/0" target="_blank">https://www.payperblock.xyz/#/mini/0</a> and check <a href="#">this documention</a> to customize your plan(s) link !<br/>
    ...
    <br/>
      <h4>Integrates seamlessly into your business stack:</h4>
      <CRow>
      <CCol lg={4}>
          <CCard>
            <CCardBody>
              <CCardTitle className="text-center">Receipts and reminders</CCardTitle>
              <CCardText>
        ...
        <CCol lg={4}>
          <CCard>
            <CCardBody>
              <CCardTitle className="text-center">Front / API</CCardTitle>
              <CCardText>
        ...
        <CCol lg={4}>
          <CCard>
            <CCardBody>
              <CCardTitle className="text-center">Webhooks</CCardTitle>
              <CCardText>
