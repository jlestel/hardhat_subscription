...
const MySubscribe = React.lazy(() => import('./views/manage/MySubscribe'))
const MySubscriptions = React.lazy(() => import('./views/manage/MySubscriptions'))
const MyPlans = React.lazy(() => import('./views/manage/MyPlans'))
const MyPlan = React.lazy(() => import('./views/manage/MyPlan'))
